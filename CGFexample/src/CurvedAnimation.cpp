...
CurvedAnimation::CurvedAnimation(float span, vector<float> controlPoints) : Animation() {
	...
	P0.push_back(controlPoints.at(0));
    P0.push_back(controlPoints.at(1));
    P0.push_back(controlPoints.at(2));
    
	P1.push_back(controlPoints.at(3));
    P1.push_back(controlPoints.at(4));
    P1.push_back(controlPoints.at(5));
    
	P2.push_back(controlPoints.at(6));
    P2.push_back(controlPoints.at(7));
    P2.push_back(controlPoints.at(8));
    
	P3.push_back(controlPoints.at(9));
    P3.push_back(controlPoints.at(10));
    P3.push_back(controlPoints.at(11));
}
